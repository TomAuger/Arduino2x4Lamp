...
class Easing {
 ...
 public:
  ...
  // breathe
  static float BreatheEaseIn(float t, float b , float c, float d);
  static float BreatheEaseOut(float t, float b , float c, float d);
  static float BreatheEaseInOut(float t, float b , float c, float d);
};
